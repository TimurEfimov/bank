...
import { ArrowLeft, RotateCcw, Crown, Trophy, Star, Zap } from "lucide-react";
...
export const SlotsGame: React.FC<SlotsGameProps> = ({
  ...
  const spinReels = () => {
    ...
    let spins = 0;
    const maxSpins = 15; // Уменьшил для более быстрой анимации
    ...
    }, 80); // Уменьшил интервал для более плавной анимации
  };
            ...
            >
              ...
              >
                {gameResult === "win" ? (
                  ...
                  <>
                    <Zap className="w-5 h-5 md:w-8 md:h-8 text-orange-400" />
                    <div>
                      <div className="text-lg md:text-2xl font-bold">
                        ПОПРОБУЙТЕ ЕЩЁ
                      </div>
          ...
          >
            {isSpinning ? (
              ...
              <div className="flex items-center justify-center gap-2 md:gap-3">
                ...
                <span className="text-sm md:text-base">ИГРАТЬ</span>
                <Zap className="w-4 h-4 md:w-6 md:h-6" />
              </div>
            )}
      ...
      <div className="relative max-w-2xl mx-auto bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl md:rounded-3xl p-4 md:p-6 border-2 border-purple-500/30 shadow-2xl shadow-purple-500/20 z-10 px-2">
        <div className="mb-4 md:mb-6">
          <div className="flex justify-between items-center mb-4 md:mb-6">
            ...
            <div className="bg-gradient-to-r from-cyan-500 to-purple-500 px-3 py-2 md:px-6 md:py-3 rounded-full font-bold text-lg md:text-xl shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-2 md:gap-3">
            ...
            <button
              ...
              className="py-2 md:py-4 bg-gradient-to-r from-blue-600 to-cyan-600 border-2 border-cyan-400 rounded-lg md:rounded-xl hover:from-blue-500 hover:to-cyan-500 transition-all duration-300 font-semibold text-sm md:text-base z-10 relative"
            >
              +500
            </button>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-2 md:gap-6 z-10">
          ...
          <div className="flex items-center justify-center gap-2 bg-purple-500/10 px-3 py-1 md:px-4 md:py-2 rounded-full border border-purple-400/30">
            <Crown className="w-3 h-3 md:w-4 md:h-4 text-purple-400" />
            <span className="text-xs md:text-sm font-semibold">
              x5 за 3 символа
            </span>
          </div>
